...
const {payResult,orderId} =route.query
</script>
  ...
  <div class="xtx-pay-page">
    <div class="container">
      ...
      <div class="pay-result">
        ...
        <p class="tit">{{payResult === 'true' ? '订单支付成功' : '支付失败'}}</p>
        <p class="tip">我们将尽快为您发货，收货期间请保持手机畅通</p>
        <p>支付方式：<span>{{orderDetail.payChannel === 1 ? '支付宝' :"微信"}}</span></p>
        <p>支付金额：<span>¥{{orderDetail.payMoney}}</span></p>
        <div class="btn">
